...
public class SelectAllQuestion extends MultipleChoiceQuestion {
	...
	public int checkAnswer(String givenAnswer) {
		...
		int totalPts=super.getChoicesNum();
		
		/*for (int i=0; i<super.getChoicesNum(); i++) {
			if (givenAnswer.equals(getAnswer())){
				totalPts++;
			}
		}*/
		return totalPts-findMissingCorrectAnswers(givenAnswer)-findIncorrectGivenAnswers(givenAnswer);
	}
